...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Function<String, String> lastName = s -> s.concat(" Busuioc");
        ...
        Predicate<String> p1 = s -> s.equals("VIOREL");
        Predicate<String> p2 = s -> s.equalsIgnoreCase("Viorel");
        Predicate<String> p3 = s -> s.startsWith("V");
